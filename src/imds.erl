...
-spec imds_response(string(), [string()], pos_integer()) -> {ok, term()} |
                                                            {error, term()}.
...
-spec imds_response(string(), [string()], pos_integer(), pos_integer()) -> {ok, term()} |
                                                                           {error, term()}.
...
-spec imds_transform_response(string(), [string()], function()) -> {error, term()} |
                                                                   term().
...
-spec call_with_retry(atom(), atom(), list(), string(), integer()) -> {ok, term()} |
                                                                      {error, term()}.
...
metadata_response_to_proplist_test() ->
    Body = <<"{\"Code\":\"Success\",\"LastUpdated\":\"2014-10-17T15:17:07-07:00\",\""
